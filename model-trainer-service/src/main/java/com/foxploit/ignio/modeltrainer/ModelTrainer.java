...
public class ModelTrainer implements CommandLineRunner {
    ...
    public static final String TRAIN_DATA_SET = "sensor-data-fr-timestamp-train-temp.csv";
    public static final String TEST_DATA_SET = "sensor-data-fr-timestamp-test-temp.csv";
    ...
    private String buildVersion = "1.0.1";
    ...
    public void run(String... args) throws Exception {
        ...
        trainReader.initialize(new FileSplit(new ClassPathResource(TRAIN_DATA_SET).getFile()));
        ...
        testReader.initialize(new FileSplit(new ClassPathResource(TEST_DATA_SET).getFile()));
