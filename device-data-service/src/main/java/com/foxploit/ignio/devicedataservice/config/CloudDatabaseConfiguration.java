...
@Configuration
@EnableMongoRepositories("com.foxploit.ignio.devicedataservice.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.foxploit.ignio.devicedataservice.config.dbmigrations");
