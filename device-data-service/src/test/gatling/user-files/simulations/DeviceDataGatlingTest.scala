...
/**
 * Performance test for the DeviceData entity.
 */
class DeviceDataGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the DeviceData entity")
        ...
        .repeat(2) {
            ...
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_deviceData_url"))).exitHereIfFailed
            .pause(10)
            .repeat(5) {
