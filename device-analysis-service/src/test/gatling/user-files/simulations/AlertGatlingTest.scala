...
class AlertGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Alert entity")
        ...
        .repeat(2) {
            ...
            .get("/services/deviceanalysisservice/api/alerts")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new alert")
            .post("/services/deviceanalysisservice/api/alerts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "deviceId":"SAMPLE_TEXT"
                , "ownerId":"SAMPLE_TEXT"
                , "alertType":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/deviceanalysisservice${new_alert_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created alert")
            .delete("/services/deviceanalysisservice${new_alert_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
