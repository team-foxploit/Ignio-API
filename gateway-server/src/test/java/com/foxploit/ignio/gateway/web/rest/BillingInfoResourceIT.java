...
public class BillingInfoResourceIT {
    ...
    private static final Set<String> DEFAULT_IGNIOS = new HashSet<>();
    private static final Set<String> UPDATED_IGNIOS = new HashSet<>();
    ...
    private static final String DEFAULT_CVV_2 = "AAAAAAAAAA";
    private static final String UPDATED_CVV_2 = "BBBBBBBBBB";

    private static final String DEFAULT_EXPIRES_ON = "AAAAAAAAAA";
    private static final String UPDATED_EXPIRES_ON = "BBBBBBBBBB";
    ...
    public void getAllBillingInfos() throws Exception {
        ...
        restBillingInfoMockMvc.perform(get("/api/billing-infos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ignios").value(hasItem(DEFAULT_IGNIOS.toString())))
            ...
            .andExpect(jsonPath("$.[*].cvv2").value(hasItem(DEFAULT_CVV_2.toString())))
    ...
    public void getBillingInfo() throws Exception {
        ...
        restBillingInfoMockMvc.perform(get("/api/billing-infos/{id}", billingInfo.getId()))
            ...
            .andExpect(jsonPath("$.ignios").value(DEFAULT_IGNIOS.toString()))
            ...
            .andExpect(jsonPath("$.cvv2").value(DEFAULT_CVV_2.toString()))
