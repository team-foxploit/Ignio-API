...
import { SensorDataComponent } from 'app/entities/devicedataservice/sensor-data/sensor-data.component';
...
describe('Component Tests', () => {
  describe('SensorData Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sensorData[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
