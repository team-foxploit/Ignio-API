...
import { DeviceDataComponent } from 'app/entities/devicedataservice/device-data/device-data.component';
...
describe('Component Tests', () => {
  describe('DeviceData Management Component', () => {
    let comp: DeviceDataComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DeviceDataComponent, '')
        .compileComponents();
