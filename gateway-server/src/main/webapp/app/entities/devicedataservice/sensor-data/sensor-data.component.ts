...
export class SensorDataComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.sensorDataService
      ...
      .subscribe(
        (res: HttpResponse<ISensorData[]>) => this.paginateSensorData(res.body, res.headers),
  ...
  trackId(index: number, item: ISensorData) {
    return item.id;
  }
  ...
  protected paginateSensorData(data: ISensorData[], headers: HttpHeaders) {
